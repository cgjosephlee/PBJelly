...
from pbsuite.utils.CommandRunner import exe, CommandRunner
...
class JellyProtocol():
    ...
    def parseProtocol(self):
        ...
        self.inputs = []
        for inputD in inputNode:

            #Do some checking on the inputs
            fullPath = os.path.join(self.baseDir, inputD.text)
        ...
        if outputNode is None:
            ...
            logging.warning("Output directory not specified. Using %s", self.outDir)
        else:
